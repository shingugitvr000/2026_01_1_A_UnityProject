...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                rb.linearVelocity += Vector3.up * Physics.gravity.y * (fallMultiplier - 1) * Time.deltaTime;        //하가 시 중력 강화
            }
        ...
        //점프 입력
        if (Input.GetButtonDown("Jump") && isGrounded)  // && 두 값을 만족할 때 -> (스페이스 버튼을 눌렀을떄와 땅 위에 있을때)
        {
